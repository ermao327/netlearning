...
insert into t_user(login_name,nickename,password) values('abcd','abcd','123');
...
insert into t_course_type (id,type_name,parent_id,status) values
(1,'硬件',null,0),(2,'软件',null,0),(3,'java',2,0),(4,'javaSe',3,0),(5,'集合',4,0);
...
insert into t_course (course_name,status,course_type_id) values ('map',0,5);
...
insert into t_chapter (course_id,title,status) values(1,'hashmap',0);
